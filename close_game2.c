...
/*   Updated: 2024/07/08 09:33:24 by dangonz3         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sl_destroy_images(t_game *game)
{
	...
	mlx_destroy_image(game->mlx_ptr, game->boss_a_sprite.sprite_ptr);
	mlx_destroy_image(game->mlx_ptr, game->boss_b_sprite.sprite_ptr);
	mlx_destroy_image(game->mlx_ptr, game->terrain_sprite.sprite_ptr);
}
