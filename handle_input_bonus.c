...
/*   Updated: 2024/06/30 19:37:25 by dangonz3         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		int current_x, int player_sprite)
{
	...
	if ((game->map.all[current_y][current_x] == EXIT && game->map.coin_number <= 0) \
	|| game->map.all[current_y][current_x] == ENEMY)
		sl_close_game(game);
	if (game->map.all[current_y][current_x] == WALL \
	|| (game->map.all[current_y][current_x] == EXIT && game->map.coin_number > 0))
		return ;
